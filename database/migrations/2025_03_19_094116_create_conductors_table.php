...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('conductors', function (Blueprint $table) {
            ...
            $table->string('jenis_conductor');
            $table->string('ukuran_conductor'); // satuan ukuran ???
            $table->float('luas_penampang'); // satuan ukuran ???
            $table->float('panjang_conductor'); // satuan ukuran ???
            ...
            $table->string('nilai_uji_tahanan_isolasi')->nullable();
