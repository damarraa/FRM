        ...
        jQuery(document).ready(function($) {
            $('.select2').select2({
                ...
                dropdownParent: $('.select2')
                    .parent(), // Pastikan dropdown memiliki parent yang tepat
                closeOnSelect: true // Pastikan opsi ini true
            }).on('change', function() {
                hitungMasaPakai();
                $(this).trigger('blur'); // Memaksa blur untuk menutup dropdown
            });
