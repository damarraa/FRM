        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr class="mb-3">
                    <form id="formInspeksi" action="{{ route('form-retur-kotak-app.update', $kotak->id) }}" method="POST"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="tgl_inspeksi" name="tgl_inspeksi"
                                        value="{{ old('tgl_inspeksi', $kotak->tgl_inspeksi) }}" readonly>
                                </div>
                            </div>
                        </div>
                        <hr class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="lokasi_akhir_terpasang" type="text" class="form-control"
                                        ...
                                        value="{{ old('lokasi_akhir_terpasang', $kotak->lokasi_akhir_terpasang) }}"
                                        required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="flex gap-4">
                                    <div class="w-1/2">
                                        ...
                                        <select class="form-control select2 w-full p-2 border rounded"
                                            ...
                                            @for ($i = date('Y'); $i >= 2000; $i--)
                                                <option value="{{ $i }}"
                                                    {{ old('tahun_produksi', $kotak->tahun_produksi) == $i ? 'selected' : '' }}>
                                                    {{ $i }}
                                                </option>
                                            @endfor
                                        </select>
                                    ...
                                    <div class="w-1/2">
                                        ...
                                        <input type="text" class="form-control w-full p-2 border rounded"
                                            ...
                                            value="{{ old('masa_pakai', $kotak->masa_pakai) }}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tipe_kotak" name="tipe_kotak" required>
                                        ...
                                        <option value="Pemasangan di Dinding"
                                            {{ old('tipe_kotak', $kotak->tipe_kotak) == 'Pemasangan di Dinding' ? 'selected' : '' }}>
                                            Pemasangan di Dinding</option>
                                        <option value="Pemasangan di Tiang"
                                            {{ old('tipe_kotak', $kotak->tipe_kotak) == 'Pemasangan di Tiang' ? 'selected' : '' }}>
                                            Pemasangan di Tiang</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="no_serial">No Serial</label>
                                    <input name="no_serial" type="number" class="form-control" id="no_serial"
                                        placeholder="Masukkan No Serial" value="{{ old('no_serial', $kotak->no_serial) }}">
                                </div>
                                <div class="form-group">
                                    <label for="pabrikan">Nama Pabrikan</label>
                                    <select name="pabrikan" class="form-control" id="pabrikan" required>
                                        <option value="">-- Pilih Pabrikan --</option>
                                        @foreach ($existingPabrikans as $pabrikan)
                                            <option value="{{ $pabrikan }}"
                                                @isset($kotak) {{ $kotak->pabrikan == $pabrikan ? 'selected' : '' }}
                                                @else
                                        ...
                                        <!-- Tambahkan opsi khusus untuk value custom yang tidak ada di existingPabrikans -->
                                        @isset($kotak)
                                            @if (!$existingPabrikans->contains($kotak->pabrikan))
                                                <option value="{{ $kotak->pabrikan }}" selected>{{ $kotak->pabrikan }}
                                                </option>
                                            @endif
                                        @endisset
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin1" id="nameplate" name="nameplate" required>
                                            ...
                                            <option value="Ada"
                                                {{ old('nameplate', $kotak->nameplate) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('nameplate', $kotak->nameplate) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                    ...
                                    <div id="keteranganNameplate" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganNameplate" name="keteranganNameplate" rows="2" maxlength="55"
                                            ...
                                            oninput="updateCharCount('keteranganNameplate', 'charCountKeteranganNameplate')">{{ old('keteranganNameplate', $kotak->keteranganNameplate) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin2" id="kondisi_selungkup"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('kondisi_selungkup', $kotak->kondisi_selungkup) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('kondisi_selungkup', $kotak->kondisi_selungkup) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganSelungkup" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganSelungkup" name="keteranganSelungkup" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganSelungkup', 'charCountKeteranganSelungkup')">{{ old('keteranganSelungkup', $kotak->keteranganSelungkup) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin3" id="kunci_pengaman" name="kunci_pengaman"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('kunci_pengaman', $kotak->kunci_pengaman) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('kunci_pengaman', $kotak->kunci_pengaman) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganKunciPengaman" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganKunciPengaman" name="keteranganKunciPengaman" rows="2"
                                            ...
                                            oninput="updateCharCount('keteranganKunciPengaman', 'charCountKeteranganKunciPengaman')">{{ old('keteranganKunciPengaman', $kotak->keteranganKunciPengaman) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin4" id="ventilasi" name="ventilasi" required>
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('ventilasi', $kotak->ventilasi) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('ventilasi', $kotak->ventilasi) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganVentilasi" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganVentilasi" name="keteranganVentilasi" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganVentilasi', 'charCountKeteranganVentilasi')">{{ old('keteranganVentilasi', $kotak->keteranganVentilasi) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin5" id="jendela_kaca" name="jendela_kaca"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('jendela_kaca', $kotak->jendela_kaca) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('jendela_kaca', $kotak->jendela_kaca) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganJendelaKaca" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganJendelaKaca" name="keteranganJendelaKaca" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganJendelaKaca', 'charCountJendelaKaca')">{{ old('keteranganJendelaKaca', $kotak->keteranganJendelaKaca) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin6" id="kuping_pemasang"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('kuping_pemasang', $kotak->kuping_pemasang) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('kuping_pemasang', $kotak->kuping_pemasang) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganKupingPemasang" class="form-group mt-2"
                                        ...
                                        <textarea class="form-control" id="keteranganKupingPemasang" name="keteranganKupingPemasang" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganKupingPemasang', 'charCountKeteranganKupingPemasang')">{{ old('keteranganKupingPemasang', $kotak->keteranganKupingPemasang) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin7" id="seal" name="seal" required>
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('seal', $kotak->seal) == 'Ada' ? 'selected' : '' }}>Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('seal', $kotak->seal) == 'Tidak ada' ? 'selected' : '' }}>Tidak
                                                ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganSeal" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganSeal" name="keteranganSeal" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..." oninput="updateCharCount('keteranganSeal', 'charCountKeteranganSeal')">{{ old('keteranganSeal', $kotak->keteranganSeal) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin8" id="logo_peringatan"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('logo_peringatan', $kotak->logo_peringatan) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('logo_peringatan', $kotak->logo_peringatan) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganLogoPeringatan" class="form-group mt-2"
                                        ...
                                        <textarea class="form-control" id="keteranganLogoPeringatan" name="keteranganLogoPeringatan" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganLogoPeringatan', 'charCountKeteranganLogoPeringatan')">{{ old('keteranganLogoPeringatan', $kotak->keteranganLogoPeringatan) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin9" id="kotak_kontak" name="kotak_kontak"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('kotak_kontak', $kotak->kotak_kontak) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('kotak_kontak', $kotak->kotak_kontak) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganKotakKontak" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganKotakKontak" name="keteranganKotakKontak" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganKotakKontak', 'charCountKeteranganKotakKontak')">{{ old('keteranganKotakKontak', $kotak->keteranganKotakKontak) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin10" id="papan_montase" name="papan_montase"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('papan_montase', $kotak->papan_montase) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('papan_montase', $kotak->papan_montase) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganPapanMontase" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganPapanMontase" name="keteranganPapanMontase" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganPapanMontase', 'charCountKeteranganPapanMontase')">{{ old('keteranganPapanMontase', $kotak->keteranganPapanMontase) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin11" id="rangka_jendela" name="rangka_jendela"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('rangka_jendela', $kotak->rangka_jendela) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('rangka_jendela', $kotak->rangka_jendela) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganRangkaJendela" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganRangkaJendela" name="keteranganRangkaJendela" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganRangkaJendela', 'charCountKeteranganRangkaJendela')">{{ old('keteranganRangkaJendela', $kotak->keteranganRangkaJendela) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin12" id="rel_mcb" name="rel_mcb" required>
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('rel_mcb', $kotak->rel_mcb) == 'Ada' ? 'selected' : '' }}>Ada
                                            </option>
                                            <option value="Tidak ada"
                                                {{ old('rel_mcb', $kotak->rel_mcb) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganRelMCB" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganRelMCB" name="keteranganRelMCB" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..." oninput="updateCharCount('keteranganRelMCB', 'charCountKeteranganRelMCB')">{{ old('keteranganRelMCB', $kotak->keteranganRelMCB) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin13" id="lubang_kabel" name="lubang_kabel"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('lubang_kabel', $kotak->lubang_kabel) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('lubang_kabel', $kotak->lubang_kabel) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganLubangKabel" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganLubangKabel" name="keteranganLubangKabel" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganLubangKabel', 'charCountKeteranganLubangKabel')">{{ old('keteranganLubangKabel', $kotak->keteranganLubangKabel) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin14" id="busbar_fasa" name="busbar_fasa"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('busbar_fasa', $kotak->busbar_fasa) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('busbar_fasa', $kotak->busbar_fasa) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganBusbarFasa" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganBusbarFasa" name="keteranganBusbarFasa" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganBusbarFasa', 'charCountKeteranganBusbarFasa')">{{ old('keteranganBusbarFasa', $kotak->keteranganBusbarFasa) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin15" id="busbar_netral" name="busbar_netral"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('busbar_netral', $kotak->busbar_netral) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('busbar_netral', $kotak->busbar_netral) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganBusbarNetral" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganBusbarNetral" name="keteranganBusbarNetral" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganBusbarNetral', 'charCountKeteranganBusbarNetral')">{{ old('keteranganBusbarNetral', $kotak->keteranganBusbarNetral) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin16" id="insulator_busbar"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('insulator_busbar', $kotak->insulator_busbar) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('insulator_busbar', $kotak->insulator_busbar) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganInsulatorBusbar" class="form-group mt-2"
                                        ...
                                        <textarea class="form-control" id="keteranganInsulatorBusbar" name="keteranganInsulatorBusbar" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganInsulatorBusbar', 'charCountKeteranganInsulatorBusbar')">{{ old('keteranganInsulatorBusbar', $kotak->keteranganInsulatorBusbar) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin17" id="indikator_shunt"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('indikator_shunt', $kotak->indikator_shunt) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('indikator_shunt', $kotak->indikator_shunt) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganIndikatorShunt" class="form-group mt-2"
                                        ...
                                        <textarea class="form-control" id="keteranganIndikatorShunt" name="keteranganIndikatorShunt" rows="2"
                                            maxlength="55" placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganIndikatorShunt', 'charCountKeteranganIndikatorShunt')">{{ old('keteranganIndikatorShunt', $kotak->keteranganIndikatorShunt) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poin18" id="saku_modem" name="saku_modem"
                                            ...
                                            <option value="">-- Hasil Pemeriksaan --</option>
                                            <option value="Ada"
                                                {{ old('saku_modem', $kotak->saku_modem) == 'Ada' ? 'selected' : '' }}>
                                                Ada</option>
                                            <option value="Tidak ada"
                                                {{ old('saku_modem', $kotak->saku_modem) == 'Tidak ada' ? 'selected' : '' }}>
                                                Tidak ada</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganSakuModem" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganSakuModem" name="keteranganSakuModem" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..."
                                            oninput="updateCharCount('keteranganSakuModem', 'charCountKeteranganSakuModem')">{{ old('keteranganSakuModem', $kotak->keteranganSakuModem) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="keteranganL1APP" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganL1APP" name="keteranganL1APP" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..." oninput="updateCharCount('keteranganL1APP', 'charCountKeteranganL1APP')">{{ old('keteranganL1APP', $kotak->keteranganL1APP) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="keteranganL2APP" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganL2APP" name="keteranganL2APP" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..." oninput="updateCharCount('keteranganL2APP', 'charCountKeteranganL2APP')">{{ old('keteranganL2APP', $kotak->keteranganL2APP) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="keteranganL3APP" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganL3APP" name="keteranganL3APP" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..." oninput="updateCharCount('keteranganL3APP', 'charCountKeteranganL3APP')">{{ old('keteranganL3APP', $kotak->keteranganL3APP) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="keteranganNAPP" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganNAPP" name="keteranganNAPP" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..." oninput="updateCharCount('keteranganNAPP', 'charCountKeteranganNAPP')">{{ old('keteranganNAPP', $kotak->keteranganNAPP) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control poinD" id="pengujian_mekanik"
                                            ...
                                            <option value="Baik"
                                                {{ old('pengujian_mekanik', $kotak->pengujian_mekanik) == 'Baik' ? 'selected' : '' }}>
                                                Baik</option>
                                            <option value="Tidak baik"
                                                {{ old('pengujian_mekanik', $kotak->pengujian_mekanik) == 'Tidak baik' ? 'selected' : '' }}>
                                                Tidak baik</option>
                                        </select>
                                        <span class="input-group-text" id="basic-addon2"
                                    ...
                                    <div id="keteranganMekanik" class="form-group mt-2" style="display: none;">
                                        ...
                                        <textarea class="form-control" id="keteranganMekanik" name="keteranganMekanik" rows="2" maxlength="55"
                                            placeholder="Masukkan keterangan..." oninput="updateCharCount('keteranganMekanik', 'charCountKeteranganMekanik')">{{ old('keteranganMekanik', $kotak->keteranganMekanik) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="kesimpulan" name="kesimpulan" required
                                            ...
                                            <option value="Bekas layak pakai (K6)"
                                                {{ old('kesimpulan', $kotak->kesimpulan) == 'Bekas layak pakai (K6)' ? 'selected' : '' }}>
                                                Bekas layak pakai (K6)</option>
                                            <option value="Bekas bisa diperbaiki (K7)"
                                                {{ old('kesimpulan', $kotak->kesimpulan) == 'Bekas bisa diperbaiki (K7)' ? 'selected' : '' }}>
                                                Bekas bisa diperbaiki (K7)
                                            </option>
                                            <option value="Bekas tidak layak pakai (K8)"
                                                {{ old('kesimpulan', $kotak->kesimpulan) == 'Bekas tidak layak pakai (K8)' ? 'selected' : '' }}>
                                    ...
                                    @if ($key < 2)
                                        <div class="form-group">
                                            ...
                                            <div id="preview{{ $key + 1 }}" class="mt-2">
                                                @if ($img)
                                                    <img src="{{ asset($img) }}"
                                                        alt="Gambar Evidence Kotak App {{ $key + 1 }}"
