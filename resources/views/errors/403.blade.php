...
<body>
    <div class="error-container">
        ...
        <h1>403</h1>
        <h2>Akses Ditolak</h2>
        <p>Anda tidak memiliki izin untuk mengakses halaman ini. Jika Anda merasa ini adalah kesalahan, silakan hubungi
            administrator.</p>
        <div class="btn-group">
            <a href="{{ route('dashboard') }}" class="btn">Kembali ke Beranda</a>
            <a href="{{ route('login') }}" class="btn btn-secondary">Halaman Login</a>
        </div>
    </div>
    <div class="wave"></div>
</body>
