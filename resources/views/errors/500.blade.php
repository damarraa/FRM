...
<body>
    <div class="error-container">
        ...
        <p>Maaf, terjadi kesalahan pada server kami. Tim teknis telah diberitahu dan sedang bekerja untuk
            memperbaikinya. Silakan coba lagi nanti.</p>
        <div class="btn-group">
            <a href="{{ route('dashboard') }}" class="btn">Kembali ke Beranda</a>
            <a href="mailto:teknisi_it@prisan.co.id" class="btn btn-secondary">Hubungi Dukungan</a>
        </div>
    </div>
    <div class="wave"></div>
</body>
