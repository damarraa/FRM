...
<body>
    <div class="error-container">
        ...
        <h1>419</h1>
        <h2>Sesi Telah Kadaluarsa</h2>
        <p>Sesi halaman Anda telah berakhir karena tidak ada aktivitas dalam waktu lama atau token CSRF tidak valid.
            Silakan refresh halaman dan coba lagi.</p>
        <div class="btn-group">
