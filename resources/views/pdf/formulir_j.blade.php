...
<head>
    ...
    <title>Formulir Inspeksi Material Retur PHBTM / Cubicle</title>
</head>
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
    <div style="max-width: 900px; background: white; padding: 30px; margin: 40px auto; border-radius: 5px;">
        ...
        <div style="">
            ...
            <div style="width: 100%; padding: 10px 20px;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr style="">
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: left; padding-left: 10px; font-size: 11px; height: 0px;">
                            Kondisi Selungkup untuk PHBTM (ada <br>
            ...
            <p style="margin-left: 22px; margin-top: -10px; font-size: 10px;">a. Poin 1 dan 2 bila terdapat cacat dapat
                diperbaiki atau dilengkapi.</p>
            <p style="margin-left: 22px; margin-top: -10px; font-size: 10px;">b. Jika poin B (3,4,5) ada yang tidak
