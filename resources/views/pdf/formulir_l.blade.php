...
<head>
    ...
    <title>Formulir Inspeksi Material Retur Trafo Arus (CT)</title>
</head>
    ...
    <div style="max-width: 900px; background: white; padding: 30px; margin: 0px; border-radius: 5px;">
        <div style="font-weight: normal; padding-bottom: 20px; font-size: 12px;">
            <div style="float: left"><span style="font-weight: bold">PT PLN (PERSERO)</span> <br> <span
                    style="font-weight: bold">UID/UIW {{ $trafo_arus->uid->wilayah }}</span> <br> UNIT
                {{ $trafo_arus->up3s->unit }}</div>
            <div style="float: right">Formulir 01-L</div>
        </div>
        ...
        <div style="text-align: center; padding-bottom: 10px;">
            <h2
                ...
                FORMULIR INSPEKSI MATERIAL RETUR TRAFO ARUS (CT)</h2>
            <p style="font-size: 14px; font-weight: bold; margin-top: 0;">NO: {{ $trafo_arus->no_surat }}</p>
        </div>
        ...
        <div style="font-size: 11px; text-align: justify; margin-top: -10px;">
            Pada hari ini <span style="font-weight: bold">{{ $hari }}</span> tanggal <span
                ...
                {{ $tahunTeks }}</span>
            telah diadakan inspeksi material retur Trafo Arus (CT) dengan data sebagai berikut:
        </div>
        ...
        <div style="">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td style="width: 50%; vertical-align: top;">
                        <ul style="list-style: none; padding: 10px 10px; margin: 0; font-size: 11px; margin-left: 10px">
                            <li style="padding: 0px 0;">Lokasi Akhir Terpasang:
                                {{ $trafo_arus->lokasi_akhir_terpasang }}</li>
                            <li style="padding: 0px 0;">Unit Layanan Pelanggan: {{ $trafo_arus->ulp->daerah }}</li>
                            <li style="padding: 0px 0;">Tahun Produksi: {{ $trafo_arus->tahun_produksi }}</li>
                    ...
                    <td style="width: 50%; vertical-align: top;">
                        <ul style="list-style: none; padding: 10px 10px; margin: 0; font-size: 11px; margin-left: 10px">
                            <li style="padding: 0px 0;">No Serial: {{ $trafo_arus->no_serial }}</li>
                            <li style="padding: 0px 0;">Nama Pabrikan: {{ $trafo_arus->pabrikan->nama_pabrikan }}</li>
                            <li style="padding: 0px 0;">Rasio: {{ $trafo_arus->rasio }}</li>
                            <li style="padding: 0px 0;">Kelas Pengukuran: {{ $trafo_arus->kelas_pengukuran }}</li>
                            <li style="padding: 0px 0;">Kelas Proteksi: {{ $trafo_arus->kelas_proteksi }}</li>
                        </ul>
                    </td>
                </tr>
            </table>
            ...
            <div style="width: 100%; padding: 10px 20px;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr style="">
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            {!! $trafo_arus->penandaan_terminal == 'Ada' ? '✔' : '' !!}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            {!! $trafo_arus->penandaan_terminal == 'Tidak ada' ? '✔' : '' !!}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px;">
                            Ada</td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            @if ($trafo_arus->penandaan_terminal == 'Ada')
                                <span style="width: 100px; height: auto; align-items: center">&#x2611;</span>
                            @else
                                <span style="width: 100px; height: auto; align-items: center">&#9746;</span>
                            @endif
                    ...
                    <tr style="">
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            {!! $trafo_arus->kelengkapan_baut_primer == 'Ada' ? '✔' : '' !!}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            {!! $trafo_arus->kelengkapan_baut_primer == 'Tidak ada' ? '✔' : '' !!}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px;">
                            Ada</td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            @if ($trafo_arus->kelengkapan_baut_primer == 'Ada')
                                <span style="width: 100px; height: auto; align-items: center">&#x2611;</span>
                            @else
                                <span style="width: 100px; height: auto; align-items: center">&#9746;</span>
                            @endif
                    ...
                    <tr style="">
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            {!! $trafo_arus->kelengkapan_baut_sekunder == 'Ada' ? '✔' : '' !!}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            {!! $trafo_arus->kelengkapan_baut_sekunder == 'Tidak ada' ? '✔' : '' !!}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px;">
                            Ada</td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            @if ($trafo_arus->kelengkapan_baut_sekunder == 'Ada')
                                <span style="width: 100px; height: auto; align-items: center">&#x2611;</span>
                            @else
                                <span style="width: 100px; height: auto; align-items: center">&#9746;</span>
                            @endif
                    ...
                    <tr style="">
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            {!! $trafo_arus->cover_terminal == 'Ada' ? '✔' : '' !!}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            {!! $trafo_arus->cover_terminal == 'Tidak ada' ? '✔' : '' !!}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px;">
                            Ada</td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            @if ($trafo_arus->cover_terminal == 'Ada')
                                <span style="width: 100px; height: auto; align-items: center">&#x2611;</span>
                            @else
                                <span style="width: 100px; height: auto; align-items: center">&#9746;</span>
                            @endif
            ...
            <div style="width: 100%; padding: 10px 20px;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px;">
                            {{ $trafo_arus->nilai_pengujian_primer }}</td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            MΩ</td>
                        <td
                    ...
                    <tr>
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px;">
                            {{ $trafo_arus->nilai_pengujian_sekunder }}</td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            MΩ</td>
                        <td
                    ...
                    <tr>
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 11px; font-family: 'DejaVu Sans', sans-serif; height: 0px;">
                            @if ($trafo_arus->kesesuaian_batas_kesalahan == 'yes')
                                <span style="width: 100px; height: auto; align-items: center">&#x2611;</span>
                            @else
                                <span style="width: 100px; height: auto; align-items: center">&#9746;</span>
                            @endif
        ...
        <p style="margin-left: 20px; margin-top: -10px; font-size: 10px;">Keterangan: Kesesuaian seluruh mata uji poin
            C adalah mandatory.</p>
