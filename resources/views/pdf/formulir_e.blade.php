    ...
    <div style="max-width: 900px; background: white; padding: 30px; margin: 40px auto; border-radius: 5px;">
        <div style="font-weight: normal; padding-bottom: 20px; font-size: 12px;">
            <div style="float: left"><span style="font-weight: bold">PT PLN (PERSERO)</span> <br> <span
                    style="font-weight: bold">UID/UIW {{ $conductor->uid->wilayah }}</span> <br> UNIT
                {{ $conductor->up3s->unit }}</div>
        ...
        <div style="text-align: center; padding-bottom: 10px;">
            <h2
                ...
                FORMULIR INSPEKSI MATERIAL RETUR KONDUKTOR</h2>
            <p style="font-size: 14px; font-weight: bold; margin-top: 0;">NO: {{ $conductor->no_surat }}</p>
        </div>
        ...
        <div style="font-size: 12px; text-align: justify; margin-top: -10px;">
            Pada hari ini <span style="font-weight: bold">{{ $hari }}</span> tanggal <span
                ...
                {{ $tahunTeks }}</span>
            telah diadakan inspeksi material retur Konduktor dengan data sebagai berikut:
        </div>
                    ...
                    <td style="width: 40%; vertical-align: top;">
                        <ul style="list-style: none; padding: 10px 10px; margin: 0; font-size: 12px; margin-left: 10px">
                            <li style="padding: 1px 0;">Lokasi Akhir Terpasang:
                                {{ $conductor->lokasi_akhir_terpasang }}</li>
                            <li style="padding: 1px 0;">Unit Layanan Pelanggan: {{ $conductor->ulp->daerah }}
                            </li>
                            <li style="padding: 1px 0;">Tahun Pemasangan:
                                {{ $conductor->tahun_pemasangan }}</li>
                        </ul>
                    </td>
                    <td style="width: 60%; vertical-align: top;">
                        <ul style="list-style: none; padding: 10px 10px; margin: 0; font-size: 11px; margin-left: -15px">
                            <li style="padding: 1px 0;">Jenis Konduktor:
                                @if ($conductor->jenis_conductor === 'AAAC')
                                    AAAC/<del>AAAC-S</del>/<del>CCSXT</del>/ {{ $conductor->ukuran_conductor }} mm2 *)
                                @elseif ($conductor->jenis_conductor === 'AAAC-S')
                                    <del>AAAC</del>/AAAC-S/<del>CCSXT</del>/ {{ $conductor->ukuran_conductor }} mm2 *)
                                @elseif ($conductor->jenis_conductor === 'CCSXT')
                                    <del>AAAC</del>/<del>AAAC-S</del>/CCSXT/ {{ $conductor->ukuran_conductor }} mm2 *)
                                @else
                                    <del>AAAC</del>/<del>AAAC-S</del>/<del>CCSXT</del>/{{ $conductor->jenis_conductor }}/ {{ $conductor->ukuran_conductor }} mm2 *)
                                @endif
                            </li>
                            <li style="padding: 1px 0;">Luas Penampang: {{ $conductor->luas_penampang }}</li>
                            <li style="padding: 1px 0;">Panjang: {{ $conductor->panjang_conductor }}</li>
                        </ul>
                    </td>
                </tr>
            </table>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr style="">
                        ...
                        <td
                            ...
                            {{ $conductor->nilai_pemeriksaan_kondisi_visual }}</td>
                        <td
                        ...
                        <td
                            ...
                            @if ($conductor->kesesuaian_pemeriksaan_kondisi_visual == 'Baik')
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 12px; height: 0px;">
                            {{ $conductor->keterangan_pemeriksaan }}</td>
                    </tr>
                    <tr style="">
                        ...
                        <td
                            style="border: 1px solid black; padding: 2px; text-align: center; font-size: 12px; height: 0px;">
                            {{ $conductor->nilai_pengujian_dimensi }}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 12px; height: 0px;">
                            mm
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 12px; height: 0px; font-family: 'DejaVu Sans', sans-serif;">
                            @if ($conductor->kesesuaian_pengujian_dimensi == 'yes')
                                <span style="width: 100px; height: auto; align-items: center">&#x2611;</span>
                            @else
                                <span style="width: 100px; height: auto; align-items: center">&#9746;</span>
                            @endif
                        ...
                        <td
                            style="border: 1px solid black; padding: 1px; text-align: center; font-size: 12px; height: 0px;">
                            {{ $conductor->keterangan_pengujian_dimensi }}</td>
                    </tr>
                </table>
            </div>
            ...
            <div style="width: 100%; padding: 10px 20px;">
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr style="height: 0px">
                        ...
                        <td
                            style="border: 1px solid black; padding: 6px; text-align: center; font-size: 12px; height: 0px;">
                            {{ $conductor->nilai_uji_tahanan_isolasi ?? '.....' }}
                        </td>
                        <td
                            style="border: 1px solid black; padding: 6px; text-align: center; font-size: 12px; height: 0px;">
                            Ohm</td>
                        ...
                        <td
                            ...
                            @if ($conductor->kesesuaian_uji_tahanan_isolasi == 'yes')
                                <span style="width: 100px; height: auto; align-items: center">&#x2611;</span>
                            @else
                                <span style="width: 100px; height: auto; align-items: center">&#9746;</span>
                            @endif
                        ...
                        <td
                            style="border: 1px solid black; padding: 6px; text-align: center; font-size: 12px; height: 0px;">
                            {{ $conductor->keterangan_uji_tahanan_isolasi }}</td>
                    </tr>
                </table>
            </div>
        </div>
                ...
                <tr>
                    <td style="text-align: center; border: none; font-size: 14px; font-weight: bold;">Yang Menyerahkan
                        <p style="margin: 0px; font-weight: normal;">Ditandatangani tanggal
                            {{ \Carbon\Carbon::parse($conductor->created_at)->format('d/m/Y') }}</p>
                    </td>
                    <td style="text-align: center; border: none; font-size: 14px; font-weight: bold;">DISETUJUI OLEH
                        <br>
                        PIC Gudang
                        <p style="margin: 0px; font-weight: normal;">Ditandatangani tanggal
                            {{ \Carbon\Carbon::parse($conductor->updated_at)->format('d/m/Y') }}</p>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; border: none; font-size: 14px; font-weight: bold;">
                        <img src="{{ $conductor->user->signature }}" width="50px" height="50px"
                            style="display: block; margin: 5px auto 10px auto;" />
                        <p style="margin: 0px;">
                            {{ $conductor->user->name ?? '............................................' }} </p>
                    </td>
                    <td style="text-align: center; border: none; font-size: 14px; font-weight: bold;">
                        <img src="{{ $conductor->approvedBy->signature }}" width="50px" height="50px"
                            style="display: block; margin: 5px auto 10px auto" />
                        <p style="margin: 0px">
                            {{ $conductor->approvedBy->name ?? '............................................' }}</p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style="page-break-before: always; margin-top: 20px;">
            ...
            @if ($conductor->gambar)
                @php
                    $gambarArray = json_decode($conductor->gambar, true);
                    ...
                    @foreach ($chunkedImages as $row)
                        <tr>
                            @foreach ($row as $gambar)
                                @php
                                    $path = public_path('gambar_conductor/' . basename($gambar));
