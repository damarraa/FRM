...
class CubicleExport implements FromCollection, WithHeadings, WithMapping, WithTitle
{
    protected $ids;
    protected $worksheetName;

    public function __construct(array $ids = null, $worksheetName = 'Cubicle')
    {
        $this->ids = $ids;
    ...
    {
        if ($this->ids) {
            return Cubicle::whereIn('id', $this->ids)->get();
        }
