...
class TiangListrikExport implements FromCollection, WithHeadings, WithMapping, WithTitle
{
    protected $ids;
    protected $worksheetName;

    public function __construct(array $ids = null, $worksheetName = 'Tiang Listrik')
    {
        $this->ids = $ids;
    ...
    {
        if ($this->ids) {
            return TiangListrik::whereIn('id', $this->ids)->get();
        }

        return TiangListrik::all();
    }
