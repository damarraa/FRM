...
class PHBTRExport implements FromCollection, WithHeadings, WithMapping, WithTitle
{
    protected $ids;
    protected $worksheetName;

    public function __construct(array $ids = null, $worksheetName = 'PHBTR')
    {
        $this->ids = $ids;
    ...
    {
        if ($this->ids) {
            return PHBTR::whereIn('id', $this->ids)->get();
        }
