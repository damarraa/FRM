...
class TrafoTeganganExport implements FromCollection, WithHeadings, WithMapping, WithTitle
{
    protected $ids;
    protected $worksheetName;

    public function __construct(array $ids = null, $worksheetName = 'PT')
    {
        $this->ids = $ids;
    ...
    {
        if ($this->ids) {
            return TrafoTegangan::whereIn('id', $this->ids)->get();
        }

        return TrafoTegangan::all();
    }
